...
@interface ViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, SelfiesServiceDelegate>

@property (weak, nonatomic) IBOutlet UICollectionView *selfiesCollectionView;
@property (nonatomic, strong) SelfiesService* service;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
   ...
   cell.selfieImageView.alpha = 0;
    ...
    dispatch_queue_t queue = dispatch_queue_create("com.us.darrell.imageDownloadQueue", NULL);
